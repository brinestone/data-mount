 ...
 */
 lookupProjects<TData = ProjectLookupOfGuid[]>(params?: LookupProjectsParams, options?: HttpClientBodyOptions): Observable<TData>;
 lookupProjects<TData = ProjectLookupOfGuid[]>(params?: LookupProjectsParams, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 lookupProjects<TData = ProjectLookupOfGuid[]>(params?: LookupProjectsParams, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  lookupProjects<TData = ProjectLookupOfGuid[]>(
    params?: LookupProjectsParams, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
